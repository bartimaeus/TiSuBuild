...
class TitaniumCommand(sublime_plugin.WindowCommand):
    ...
    def pick_platform(self):
        self.platforms = ["ios", "android",  "clean"]
    ...
    def select_ios_target(self, select):
        ...
        if self.target == "simulator":
            self.simtype = ["iPhone 4", "iPhone 4S with iOS 6", "iPhone 4S with iOS 7", "iPhone 5 with iOS 6", "iPhone 5 with iOS 7", "iPhone 5S 64bit", "iPad"]
    ...
    def select_ios_simtype(self, select):
        ...
        if (self.simtype[select] == 'iPhone 4 with iOS 6'):
            ...
            options = ['-Y', 'iphone', '-sim-64-bit', '--retina', '--tall']
